...
class TokenActions extends \Magento\Ui\Component\Listing\Columns\Column
{

    const URL_PATH_DELETE = 'shinesoftware_ghostlogin/token/delete';
    const URL_PATH_EDIT = 'shinesoftware_ghostlogin/token/edit';
    const URL_PATH_DETAILS = 'shinesoftware_ghostlogin/token/details';
