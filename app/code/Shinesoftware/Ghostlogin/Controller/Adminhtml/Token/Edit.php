...
class Edit extends \Shinesoftware\Ghostlogin\Controller\Adminhtml\Token
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('shinesoftware_ghostlogin_token', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend(__('Ghost Link'));
        return $resultPage;
    }
}
