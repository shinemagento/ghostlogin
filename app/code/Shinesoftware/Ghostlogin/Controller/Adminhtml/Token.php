...
namespace Shinesoftware\Ghostlogin\Controller\Adminhtml;

abstract class Token extends \Magento\Backend\App\Action
{
    ...
    public function initPage($resultPage)
    {
        $resultPage->setActiveMenu(self::ADMIN_RESOURCE)
            ->addBreadcrumb(__('Shinesoftware'), __('Shinesoftware'))
            ->addBreadcrumb(__('Token'), __('Token'));
        return $resultPage;
    }
}
