...
namespace Shinesoftware\Ghostlogin\Model\Token;

use Shinesoftware\Ghostlogin\Model\ResourceModel\Token\CollectionFactory;
...
class DataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    ...
    public function getData()
    {
        ...
        $data = $this->dataPersistor->get('shinesoftware_ghostlogin_token');
